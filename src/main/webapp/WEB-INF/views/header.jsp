...
<meta name="description" content="Вопросы и ответы для аттестации специалистов и руководителей строительства">
...
<title>Q-lab: Аттестация специалистов в строительстве РБ. Вопросы и ответы.</title>
